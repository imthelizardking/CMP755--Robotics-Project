function robot = robot_test(dataFormat)
%robot_test Create rigidBodyTree for the robot model
%   ROBOT = robot_test(DATAFORMAT) constructs a rigidBodyTree, ROBOT, and sets the
...
%   Auto-generated by MATLAB on 08-Jan-2023 15:17:19
